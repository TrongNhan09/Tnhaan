...
EGLBoolean _eglSwapBuffers(EGLDisplay dpy, EGLSurface surface) {
	...
	if (ImGui::Begin(OBFUSCATE("MOD AOV BY TNHAAN MOD")), nullptr , ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoCollapse) {
       ...
       if (ImGui::BeginTabItem(OBFUSCATE(ICON_MD_MAP" MENU HACK")))
        {
       ...
       if (ImGui::BeginTabItem(OBFUSCATE(ICON_MD_CAMERA" MENU CAMERA")))
        {
        ...
        if (ImGui::BeginTabItem(OBFUSCATE(ICON_MD_KEY" ADMIN INFO")))
        {
            ...
            ImGui::Text(OBFUSCATE("THÔNG TIN LIÊN HỆ:"));
			ImGui::Text(OBFUSCATE("TNHAAN MOD"));
			ImGui::Text(OBFUSCATE("Zalo : 0834395074"));
			ImGui::Text(OBFUSCATE("Telegram : @tnhaanshop "));
    ...
    if (instance != NULL) {
        ...
        if (HudControl > 0 && SkillControl > 0) {
            ...
            if (Config.FEATMenu.showCd) {
                ...
                String *playerName = Il2CppString::Create("TNHAAN MOD");
...
void *Init_Thread(void *) {
    ...
    OpenURL = (void (*)(String *))IL2Cpp::Il2CppGetMethodOffset("UnityEngine.CoreModule.dll","UnityEngine","Application","OpenURL",1);
        ...
        MemoryPatch::createWithHex("libanogs.so", 0x73544, "1EFF2FE1").Modify();
MemoryPatch::createWithHex("libanogs.so", 0x27BC90, "00207047").Modify();
MemoryPatch::createWithHex("libanogs.so", 0x27BC94, "00207047").Modify();
MemoryPatch::createWithHex("libanogs.so", 0x310690, "00000000").Modify();
MemoryPatch::createWithHex("libanogs.so", 0x311404, "00207047").Modify();;
MemoryPatch::createWithHex("libanogs.so", 0x317008, "00000000").Modify();
MemoryPatch::createWithHex("libanogs.so", 0x31702C, "00000000").Modify();
MemoryPatch::createWithHex("libanogs.so", 0x317030, "00000000").Modify();
MemoryPatch::createWithHex("libanogs.so", 0x333340, "00207047").Modify();
MemoryPatch::createWithHex("libanogs.so", 0x143070, "0000A0E3").Modify();
MemoryPatch::createWithHex("libanogs.so", 0x143074, "1F2FE1E2").Modify();
MemoryPatch::createWithHex("libanogs.so", 0x271BEC, "00207047").Modify();
MemoryPatch::createWithHex("libanogs.so", 0x2A179C, "00207047").Modify();
MemoryPatch::createWithHex("libanogs.so", 0x7156A, "00207047").Modify();
MemoryPatch::createWithHex("libanogs.so", 0x7351A, "1EFF2FE1").Modify();
